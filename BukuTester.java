...
public class BukuTester {
    public static void main(String[] args) {
        ...
        Buku perpus = new Buku(id,judul,pengarang,tahunTerbit);
        System.out.println(perpus.judul);
        System.out.println(perpus.pengarang);
        System.out.println(perpus.id);
        System.out.println(perpus.tahunTerbit);
